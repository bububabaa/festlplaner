                                        ...
                                        <div class="banner-caption">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <h4><?php echo $arrstrasse[$rdm_2]; echo " "; echo $arrhausnummer[$rdm_2]?></h4>
                                                    <h4><?php echo $arrplz[$rdm_2]; echo " "; echo $arrort[$rdm_2]?></h4>
                                                    <h4><?php echo $arreintritt[$rdm_2]; echo " €"?></h4>
                                                    ...
                                                    <h4>
                                                        <?php echo $arrbeschreibung[$rdm_2]?>
                                                    </h4>
                                                </div>
